                ...
                errorApp.Run(async context =>
                {
                    ...
                    var problem = new ProblemDetails
                    {
                        Status = exception switch
                        {
                            ...
                            ConfirmationLinkMismatchException _ => StatusCodes.Status400BadRequest,
                            ResetPasswordLinkMismatchException _ => StatusCodes.Status400BadRequest,
                            ...
                            AppClientException _ => StatusCodes.Status500InternalServerError,
                        ...
                        Detail = exception switch
                        {
                            ...
                            ResetPasswordLinkMismatchException rpl => rpl.Message,
                            ...
                            AppClientException cf => cf.Message,
