...
namespace Infrastructure.Repositories
{
    public class RefreshTokenRepository : IRefreshTokenRepository
    {
        ...
        public async Task<int> AddAsync(RefreshToken refreshToken, CancellationToken ct)
        {
            await RevokeAsync(refreshToken.UserId, refreshToken.SessionId, ct);
        ...
        public async Task<RefreshToken?> GetAsync(string tokenValue, CancellationToken ct)
        {
        ...
        public async Task<int> RevokeAsync(Guid userId, string sessionId, CancellationToken ct)
        {
        ...
        public async Task<bool> ValidateAsync(Guid userId, string sessionId, CancellationToken ct)
        {
            // Cache-Aside for refresh token
        ...
        public async Task<RefreshToken> UpdateAsync(RefreshToken oldRefreshToken, RefreshToken newRefreshToken, CancellationToken ct)
        {
